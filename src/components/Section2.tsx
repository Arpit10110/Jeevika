        ...
        <div className='flex  justify-around items-center flex-wrap mt-[5rem] gap-y-[3rem] ' >
            {
                biddingSteps.map((i,index)=>{
                    return(
                        <div className='w-[40%] max-tablet:w-[70%] max-mobile:w-[90%]  bg-gray-200 p-[1rem] flex flex-col gap-[0.8rem] items-center rounded-[5px] cursor-pointer hover:scale-[1.02] transition-all py-[3.5rem] px-[3rem] shadow-[0px_4px_10px_4px_#4042437d]' key={index}>
                            <h3  >{i.icon}</h3>
